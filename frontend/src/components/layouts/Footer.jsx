...
const SocialLink = ({ children }) => (
  <a
    href="#"
    className="w-9 h-9 rounded-lg border border-white/10 bg-white/5 flex items-center justify-center text-gray-400 transition-all hover:text-orange-500 hover:bg-orange-500/10 hover:border-orange-500/30 no-underline"
  >
    {children}
  </a>
);
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-3">
        <p className="text-xs text-gray-600 text-center sm:text-left">
          © 2026 NayePankh Foundation. Bridging the gap with AI.
        </p>
